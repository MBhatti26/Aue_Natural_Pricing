...
class AueNaturalDataProcessor:
    ...
    def show_database_setup_info(self):
        ...
        print("  • Database: aue_warehouse")
        print("  • Schema: aue")
        print("  • Import script: src/load_to_db.py")
        print()
        print("🚀 Data already loaded into PostgreSQL:")
        print("  • Use: psql -U postgres -d aue_warehouse")
        print("  • Query: SELECT * FROM aue.product LIMIT 5;")
    ...
    def process_new_data(self):
        ...
        try:
            ...
            dedup_file, dedup_stats = self.dedup_manager.deduplicate_file(latest_raw_file)
