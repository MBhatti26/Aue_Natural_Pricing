...
def create_normalized_tables(input_file, output_dir="."):
    ...
    price_history = df[['product_id', 'retailer_id', 'price', 'currency', 'timestamp']].copy()
    ...
    price_history = price_history[['price_id', 'product_id', 'retailer_id', 'price', 'discount', 'currency', 'date_collected']]
